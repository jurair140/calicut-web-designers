...
const Projects = () => {
  ...
  return (
    ...
    <div className='flex justify-end items-center mb-8'>
        <button className='p-3 bg-gray-200 roundedmr-2 mr-1' aria-label='Previous Projects'>
        <ChevronsLeft  />
        </button>
        <button className='p-3 bg-gray-200 roundedmr-2 ' aria-label='Next Projects'>
        <ChevronsRight /> 
        </button>
    </div>
    ...
    <div className=''>
        <div className='flex flex-wrap justify-around gap-10 mb-8'>
            ...
            <div className='relative flex-shrink-0 w-full sm:w-1/4 border'>
                <img src="https://calicutwebdesigners.com/site_assets/img/case/case-grid22.png" className='w-full h-auto mb-14' alt="" />

                
                <div className='absolute left-0 right-0 bottom-5 flex justify-center bg-gray-200'>
                    <div className='flex justify-between  w-3/4 px-4 py-2 shadow-md'>
                    <h2 className='text-xl font-semibold text-gray-800'>
                    Hoowa                    </h2>
                    <a href='' className='text-gray-500 hover:text-yellow-800'>
                    <Link/>
            ...
            <div className='relative flex-shrink-0 w-full sm:w-1/4 border'>
                <img src="https://calicutwebdesigners.com/site_assets/img/case/case-grid23.png" className='w-full h-auto mb-14' alt="" />
            ...
            <div className='relative flex-shrink-0 w-full sm:w-1/4 border'>
                <img src="	https://calicutwebdesigners.com/site_assets/img/case/case-grid24.png" className='w-full h-auto mb-14' alt="" />

                
                <div className='absolute left-0 right-0 bottom-5 flex justify-center bg-gray-400'>
                    <div className='flex justify-between  w-3/4 px-4 py-2 shadow-md bg-gray-200'>
                    <h2 className='text-xl font-semibold text-gray-800'>
                    Brilliance Academy                    </h2>
                    <a href='' className='text-gray-500 hover:text-yellow-800'>
                    <Link/>
                    </a>
